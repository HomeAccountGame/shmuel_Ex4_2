...
public class com_play : MonoBehaviour
{
    ...
    void Update()
    {
        num_card = GameObject.Find("com1-1");
        changeVal temp = num_card.GetComponent<changeVal>();
        value1 = temp.value;
        num_card = GameObject.Find("com1-2");
        temp = num_card.GetComponent<changeVal>();
        value2 = temp.value;
        num_card = GameObject.Find("com1-3");
        temp = num_card.GetComponent<changeVal>();
        value3 = temp.value;
        num_card = GameObject.Find("com1-4");
        temp = num_card.GetComponent<changeVal>();
        value4 = temp.value;
    }
    public void turn()
