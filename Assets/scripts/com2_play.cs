...
public class com2_play : MonoBehaviour
{
    ...
    void Update()
    {
        num_card = GameObject.Find("com2-1");
        changeVal temp = num_card.GetComponent<changeVal>();
        value1 = temp.value;
        num_card = GameObject.Find("com2-2");
        temp = num_card.GetComponent<changeVal>();
        value2 = temp.value;
        num_card = GameObject.Find("com2-3");
        temp = num_card.GetComponent<changeVal>();
        value3 = temp.value;
        num_card = GameObject.Find("com2-4");
        temp = num_card.GetComponent<changeVal>();
        value4 = temp.value;
    }
    public void turn()
